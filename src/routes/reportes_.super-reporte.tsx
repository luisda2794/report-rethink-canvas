...
import { getClientesLocalesConfig } from "@/lib/clientes-locales-config";
import { categorizeCliente, CATEGORIA_ORDER, CATEGORIA_LABEL, type Categoria } from "@/lib/client-category";
